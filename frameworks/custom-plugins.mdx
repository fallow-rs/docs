...
Need support for an internal framework or a tool fallow doesn't cover yet? Create an external plugin file. No Rust code needed. Plugins are declarative JSON/TOML files that teach fallow about your framework's conventions.
