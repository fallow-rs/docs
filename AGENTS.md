...
Mintlify documentation site for [fallow](https://github.com/fallow-rs/fallow), a dead code and duplication analyzer for TypeScript/JavaScript. Built in Rust. Three audiences: AI agents, human developers, CI pipelines.
...
- 14 issue types (unused files, exports, types, dependencies, devDependencies, optionalDependencies, enum members, class members, unresolved imports, unlisted deps, duplicate exports, circular dependencies, type-only dependencies, test-only dependencies).
- 84 built-in plugins.
...
5. Verify counts still match: 84 plugins, 14 issue types, 141 knip plugins.
