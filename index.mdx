...
description: "Get started with Fallow: codebase intelligence for TypeScript, JavaScript, and styling. Static analysis for unused code, duplication, complexity, architecture drift, and design-system styling consistency. Optional runtime intelligence for hot paths, cold paths, and deletion confidence."
...
Fallow is **codebase intelligence for TypeScript, JavaScript, and styling**.
...
<CardGroup cols={2}>
  <Card title="Static intelligence" icon="diagram-project" href="/quickstart">
    Open source analysis for code structure, cleanup, duplication, and styling.
  </Card>
  <Card title="Runtime intelligence" icon="chart-network" href="/explanations/static-vs-runtime">
    Runtime evidence for what actually ran in production.
  </Card>
</CardGroup>
