...
description: "Unused code, circular dependencies, code duplication, complexity hotspots, and architecture boundary violations. Found in seconds, not minutes. Rust-native, 90 framework plugins, zero config."
...
<CardGroup cols={2}>
  ...
  <Card title="Production coverage" icon="chart-network" href="/analysis/production-coverage">
    Merge runtime coverage into health analysis to find cold functions, hot paths, and code that changed in the busiest execution paths.
  </Card>
