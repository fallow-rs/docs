...
The **unit size** penalty kicks in when more than 5% of functions exceed 60 LOC (very high risk). The **coupling** penalty kicks in when the 95th percentile fan-in exceeds 30.
