...
- **Test files**: Test cases often repeat setup code intentionally. Abstracting test setup can make tests harder to understand and debug. Use [`--production`](/cli/global-flags) to exclude test/story/dev files entirely, or use `dupes.ignore` patterns for more granular control.
