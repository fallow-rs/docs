...
description: "What Fallow analyzes: dead code, duplication, architecture boundaries, auto-fix, and runtime-backed production coverage."
keywords: ["analysis", "dead code", "duplication", "boundaries", "auto-fix", "production coverage", "complexity", "health"]
