...
<Tabs>
  <Tab title="HTML">
    ...
    **What's supported:**
    ...
    - Root-relative paths (e.g., `<script src="/src/main.tsx">`) are resolved against the project root, matching the convention used by Vite, Parcel, and similar dev servers
