...
Fallow doesn't just analyze `.js` and `.ts` files. It extracts imports and exports from a range of non-JavaScript file types, so your module graph stays complete without manual configuration.
...
<CardGroup cols={2}>
  ...
  <Card title="Built-in plugins" icon="puzzle-piece" href="/frameworks/built-in">
    79 framework plugins for automatic entry point detection.
  </Card>
</CardGroup>
