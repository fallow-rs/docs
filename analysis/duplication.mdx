...
<Tabs>
  ...
  <Tab title="Mild (default)">
    The default mode. Since fallow uses AST-based tokenization, whitespace and comments are already absent from the token stream. Strict and mild modes are currently equivalent in behavior.
