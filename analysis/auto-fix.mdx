...
<Steps>
  ...
  <Step title="Apply fixes">
    Once you're happy with the preview, apply the changes. In interactive terminals, fallow asks for confirmation before writing.
...
<Warning>
Auto-fix does not delete entire files or remove unused class members. Use `fallow check` to find those and remove them manually.
</Warning>
