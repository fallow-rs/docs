...
Auto-fix is especially powerful in agent workflows. After generating code, an agent can run `fallow fix --yes --format json` to automatically clean up unused exports and dependencies it introduced — closing the loop on AI-generated dead code.
