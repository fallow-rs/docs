...
<Steps>
  <Step title="Preview changes">
    ...
    Would remove export from src/hooks/useAuth.ts:9 (AuthContext)
    Would remove dependency: moment (from package.json)
    Would remove dependency: lodash.merge (from package.json)

    5 changes to apply (3 exports, 2 dependencies)
