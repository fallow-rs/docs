...
- **Unused exports**: the `export` keyword is removed, keeping the declaration. For exported enums that are also unused inside the same file, the entire `enum` block is deleted.
