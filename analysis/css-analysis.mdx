...
keywords: ["CSS", "SCSS", "Tailwind", "CSS Modules", "SCSS partials", "@use", "@forward", "@import", "@apply", "@tailwind", "false positives", "unused dependencies", "dead code"]
icon: "paintbrush"
---
