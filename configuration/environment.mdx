...
| `FALLOW_MAX_FILE_SIZE` | Skip source files larger than this many megabytes at discovery (mirrors `--max-file-size`; `.d.ts` always analyzed) | Whole megabytes (default `5`; `0` disables) |
