...
For library-specific allowlists that should only activate when the library is installed, prefer a plugin file with the `usedClassMembers` field. See [Plugin authoring](/configuration/plugin-authoring) for the plugin format.
</Accordion>
