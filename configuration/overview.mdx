...
<Warning>
Avoid overly broad `ignorePatterns`, which exclude files from analysis entirely. Use `ignoreExports` for finer control over which exports are considered used.
</Warning>
