...
|:------|:-----|:--------|:------------|
| `mode` | `"strict"` \| `"mild"` | `"strict"` | Detection mode. `mild` allows minor differences between clones. |
...
| `threshold` | `number` | `10` | Maximum duplication percentage before failing (exit code 1) |
...
| `crossLanguage` | `boolean` | `false` | Enable cross-language clone detection |
| `normalization` | `object` | — | Fine-grained normalization: `ignoreIdentifiers`, `ignoreStringValues`, `ignoreNumericValues` |
