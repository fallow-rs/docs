...
description: "Suppress fallow findings with inline fallow-ignore comments. Handle false positives and intentional exceptions without changing your config."
