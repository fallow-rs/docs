...
Exports annotated with `/** @public */` are never reported as unused. Use this for library APIs consumed by external projects. They have zero internal references but are intentionally part of your public API surface.
...
The tag works with all export types: named, default, classes, interfaces, enums, type aliases, and multi-specifier exports (`export { foo, bar }`).
