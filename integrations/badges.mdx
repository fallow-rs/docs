...
| Project | Badge |
|---------|-------|
| zod | ![zod](https://github.com/fallow-rs/fallow/releases/download/v2.7.2/zod.svg) |
| preact | ![preact](https://github.com/fallow-rs/fallow/releases/download/v2.7.2/preact.svg) |
| svelte | ![svelte](https://github.com/fallow-rs/fallow/releases/download/v2.7.2/svelte.svg) |
| vite | ![vite](https://github.com/fallow-rs/fallow/releases/download/v2.7.2/vite.svg) |
