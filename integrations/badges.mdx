...
The SVG needs a stable URL for your README to reference. Three options, from simplest to most reliable. Options 2 and 3 render only for public repositories; see [Private repositories](#private-repositories).
