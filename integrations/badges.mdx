...
<Tabs>
  <Tab title="GitHub Actions">
    ...
    <Warning>
      `raw.githubusercontent.com` URLs only render for **public** repositories. See [Private repositories](#private-repositories).
    </Warning>
  </Tab>
  <Tab title="GitLab CI">
    ```yaml
...
This keeps the badge rendering on shields.io's CDN and always shows the latest score. Like Option 2, this only works for **public** repositories. See [Private repositories](#private-repositories).
