...
- **Real-time diagnostics** for all 14 dead code issue types, updated via LSP without running a separate CLI process
...
1. **Agents** run `fallow dead-code` from CLI or call MCP tools to verify their own output
...
<CardGroup cols={3}>
  ...
  <Card title="Dead code analysis" icon="skull-crossbones" href="/analysis/dead-code">
    The 14 issue types shown in real time by the extension.
  </Card>
</CardGroup>
