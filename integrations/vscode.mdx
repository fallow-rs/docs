...
<Accordion title="Extension settings">
  ...
  | `fallow.duplication.near` | `false` | Include function-scoped near-miss clones with small structural edits alongside exact clones. Requires Fallow 3.14.0 or newer. |
