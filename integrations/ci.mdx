...
<Tabs>
  <Tab title="GitHub Action">
    <Steps>
      ...
      <Step title="Configure inputs">
        ...
        | `type-aware` | `false` | Turn on optional project-wide TypeScript semantic evidence. Does not report compiler diagnostics or generic typed lint findings. |
  ...
  <Tab title="Manual Setup">
    ...
    Reports complexity hotspots and circular dependencies. To change the threshold, use `--max-cyclomatic 15`.
  </Tab>
  <Tab title="Other CI">
