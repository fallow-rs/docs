  ...
  <Tab title="GitLab CI">
    <Steps>
      ...
      <Step title="Configure variables">
        ...
        | `FALLOW_VERSION` | `latest` | Fallow version to use. GitLab CI does not auto-detect the project `package.json` pin; set this explicitly when CI should match a locally pinned `fallow` dependency. |
