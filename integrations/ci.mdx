...
CI runs fallow on every push and PR. If dead code slips through, CI catches it. Your agent ran `fallow check` after generating code. Your developer saw diagnostics in VS Code. CI makes sure **nothing lands in main without passing static analysis**.
