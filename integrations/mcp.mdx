...
description: "How AI agents use fallow via CLI and MCP to find dead code, detect duplication, and auto-fix. These are capabilities LLMs fundamentally cannot do themselves."
