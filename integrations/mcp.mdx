...
keywords: ["MCP", "Model Context Protocol", "AI agent", "Claude Code", "Cursor", "tool integration"]
icon: "robot"
---
...
<Info>
Tools return JSON for direct use in AI model outputs. Agents can analyze dead code, find duplicates, and apply fixes — all through structured tool calls.
</Info>
