---
title: "Quick start"
description: "Set up fallow for your agents, your editor, or your CI pipeline in under a minute."
  ...
  <Tab title="Agents (CLI + MCP)">
    <Steps>
      ...
      <Step title="Find duplicated code">
        ...
        This finds copy-pasted code blocks across your codebase — something LLMs fundamentally can't do because they'd need to read and compare every file.
      </Step>
      ...
      <Step title="Add MCP (optional)">
        ...
        This exposes `analyze`, `find_dupes`, `fix_preview`, `fix_apply`, and `project_info` as typed tools. [Full MCP setup](/integrations/mcp)
      </Step>
    </Steps>
  </Tab>
