...
<Info>
  Benchmarked on 6 real-world open-source projects from 174 to 20,416 files. On small-to-medium projects, fallow is 5-41x faster than knip v5 and 2-18x faster than knip v6. On the largest monorepos (next.js, vue/core), knip errors out without producing results. Fallow is the only tool that completes. * knip errors out on next.js (exits without valid results).
</Info>
...
| Speed vs knip v6 | **2-18x faster** | Baseline |
