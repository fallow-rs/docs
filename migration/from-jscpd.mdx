...
description: "Migrate from jscpd to fallow for 8-34x faster duplication detection. One command converts your jscpd config and adds dead code analysis."
...
| | fallow | jscpd |
|:--|:-------|:------|
| Speed (real-world) | **8--34x faster** | Baseline |
