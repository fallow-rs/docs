...
description: "Migrate from jscpd to fallow when you want duplication detection together with unused code, complexity, circular dependencies, and architecture boundaries."
