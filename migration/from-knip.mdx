...
<Tabs>
  ...
  <Tab title="Coverage">
    ...
    | Metric | fallow | knip |
    |:-------|:-------|:-----|
    | Framework plugins | 84 (31 with config parsing) | 141 |
    | Dead code issue types | 11 | Comparable |
...
Knip has broader plugin coverage (141 vs 84). Fallow covers the most popular frameworks. If your framework isn't supported, you can create a custom plugin.
