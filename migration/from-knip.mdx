...
<Tabs>
  ...
  <Tab title="Coverage">
    ...
    | Metric | fallow | knip |
    |:-------|:-------|:-----|
    | Framework plugins | 79 (30 with config parsing) | 140+ |
...
Knip has broader plugin coverage (140+ vs 79). Fallow covers the most popular frameworks. If your framework isn't supported, you can create a custom plugin.
