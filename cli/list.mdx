...
tooling (the verbatim `auto_discover` strings, the pre-expansion zone index and
rule, the group `status`, and per-child attribution). The full shape is
documented in
