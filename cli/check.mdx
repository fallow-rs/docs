...
keywords: ["fallow check", "dead code", "CLI", "unused exports", "unused files", "SARIF", "baseline"]
icon: "terminal"
---
...
```bash title="$ fallow check --format compact"
src/utils/format.ts:12:unused-export:formatCurrency
src/utils/format.ts:28:unused-export:formatPercentage
src/legacy/oldApi.ts:1:unused-file
src/hooks/useAuth.ts:9:unused-export:AuthContext
package.json:unused-dependency:moment
```
