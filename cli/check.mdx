---
title: "fallow check"
description: "CLI reference for fallow check. Scan entry points, trace reachable exports, and report unused files, exports, dependencies, and types."
...
fallow check --baseline .fallow-baseline.json
```
