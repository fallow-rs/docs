...
Render your codebase as an interactive map. `fallow viz` runs one project analysis and writes a single self-contained HTML file (no server, no external assets) styled like the rest of fallow. It is read-only.
