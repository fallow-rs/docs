...
`fallow init --agents` writes a short starter `AGENTS.md` with project-overview, architecture, command, fallow workflow, and agent-rule prompts. It refuses to overwrite an existing `AGENTS.md`, and it is guidance for agents, not a readiness score.
