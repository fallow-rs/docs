---
title: "Global flags"
description: "Global CLI flags available on every fallow command, including root, config, format, cache, threads, workspace, score, trend, and snapshot options."
keywords: ["global flags", "CLI options", "root", "config", "format", "cache", "threads", "workspace", "score", "trend", "snapshot"]
icon: "sliders"
---
