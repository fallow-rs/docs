...
| `--group-by <MODE>` | Group output by CODEOWNERS ownership (`owner`) or first directory component (`directory`). When active, all output formats partition issues into labeled groups. |
