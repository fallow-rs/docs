...
| Code | Meaning |
|:-----|:--------|
| `0` | The default view succeeded: a config file was found and loaded, or, on a zero-config project, the effective defaults were printed |
...
The `loaded config: ...` disclosure goes to stderr, so stdout is the JSON document alone. See [Loaded config disclosure](/cli/global-flags#loaded-config-disclosure).
