...
description: "CLI reference for fallow license. Activate a trial or JWT, inspect status, refresh a license, or deactivate the local token for paid production coverage."
keywords: ["fallow license", "trial", "license activate", "license refresh", "production coverage", "JWT", "CLI"]
icon: "key"
---
