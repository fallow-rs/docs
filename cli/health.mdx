...
```json title="$ fallow health --format sarif (excerpt)"
{
  ...
  "version": "2.1.0",
  "runs": [{
    "tool": { "driver": { "name": "fallow", "version": "2.40.1" } },
    "results": [
      {
