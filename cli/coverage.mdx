...
description: "CLI reference for fallow coverage. Run the resumable setup flow, analyze local or cloud runtime coverage, and push static inventory so the dashboard can surface untracked code."
