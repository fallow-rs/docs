...
keywords: ["fallow coverage", "coverage setup", "upload-inventory", "fallow-cov", "production coverage", "runtime coverage", "CLI"]
icon: "wand-magic-sparkles"
---

`fallow coverage` groups the paid Production Coverage workflow commands:
...
| Flag | Description |
|:-----|:------------|
| `--api-key <KEY>` | Fallow cloud bearer token. |
